# Vagrant box Rocky Linux 10 LAMP

Make a Vagrant box with Rocky Linux 10 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Rocky Linux 10, Apache 2.4, MariaDB 12.1, PHP 8.4, Python 3.12, Ruby 3.3.10, Git 2+.
...
```bash
mkdir -p ~/VM && cd $_
git clone --depth=1 https://github.com/stemar/vagrant-rockylinux-10.git rockylinux-10
cd ~/VM/rockylinux-10
...
- 64bit Rocky Linux 10 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/rockylinux-10).
